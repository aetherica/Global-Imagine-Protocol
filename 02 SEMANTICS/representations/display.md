...
Representation is information encoded or structured for interpretation. Display is the system or mechanism presenting that information.
...
Potential canonical relations include `presents`, `displays`, `uses-representation`, `observed-by`, `under-viewing-condition`, and `affects-perception`.
